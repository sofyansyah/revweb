...
<div class="container">
	...
	<form role="form" action="{{url('post-testimonial')}}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}
		<div class="panel panel-primary setup-content" id="step-1" style=" margin-top: 20px;">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<input placeholder="Title" name="judul" type="text" class="form-control">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<input placeholder="Nama Tempat" name="nama_tempat" type="text" class="form-control">
				</div>
				<div class="form-group">
					<input name="rate_tempat" type="number" class="form-control" value="0" max="10">
				</div>
				<div class="form-group">
					<input placeholder="Nama Menu" name="nama_menu" type="text" class="form-control">
				</div>
				<div class="form-group">
					<input name="rate_menu" type="number" class="form-control" value="0" max="10">
				</div>
